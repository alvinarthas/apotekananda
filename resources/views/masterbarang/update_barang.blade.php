          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" name="barang" class="form-control" value="{{$barang->barang}}" placeholder="Nama Barang" required>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" name="kode_barang" class="form-control" value="{{$barang->kode_barang}}" placeholder="Kode Barang" required>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="number" name="min_qty" class="form-control" value="{{$barang->min_qty}}" placeholder="Minimal Barang"required>
              </div>
            </div>
          </div>
        </div>
